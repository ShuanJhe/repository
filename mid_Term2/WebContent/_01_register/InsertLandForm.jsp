...
<table border="1" >
<thead>
<tr bgcolor='#99BBFF' ><th height="60" colspan="2" align="center">新增土地資料</th></tr>
</thead>
<tbody >

	<tr bgcolor='#99BBFF'>
					<td width="220" height="40">號碼:</td>
					<td width="600" height="40" align="left"><input id='number'
						style="text-align: left" name="number" value="" type="text"
						size="14"></td>
				</tr>
